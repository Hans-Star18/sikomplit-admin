...
export const editorTheme: EditorThemeClasses = {
    ...
    paragraph: 'leading-4 mb-2',
    quote: 'border-l-2 pl-4 italic my-2',
    link: 'text-blue-600 hover:underline hover:cursor-pointer',
    list: {
        checklist: 'relative',
        listitem: 'mx-4',
        listitemChecked:
            'relative mx-2 px-4 list-none outline-none line-through before:content-[""] before:w-4 before:h-4 before:top-0.5 before:left-0 before:cursor-pointer before:block before:bg-cover before:absolute before:border before:border-primary before:rounded before:bg-primary before:bg-no-repeat after:content-[""] after:cursor-pointer after:border-white after:border-solid after:absolute after:block after:top-[6px] after:w-[3px] after:left-[7px] after:right-[7px] after:h-[6px] after:rotate-45 after:border-r-2 after:border-b-2 after:border-l-0 after:border-t-0',
        listitemUnchecked:
            'relative mx-2 px-4 list-none outline-none before:content-[""] before:w-4 before:h-4 before:top-0.5 before:left-0 before:cursor-pointer before:block before:bg-cover before:absolute before:border before:border-primary before:rounded',
        nested: {
            listitem: 'list-none before:hidden after:hidden',
        },
        ol: 'my-2 ml-4 list-decimal [&>li]:mt-1',
        olDepth: [
